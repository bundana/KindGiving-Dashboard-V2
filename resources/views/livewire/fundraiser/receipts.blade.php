    ...
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">{{ ucfirst($method) ? : 'All'}} Receipts</h3>
    ...
    <div class="nk-block">
        <div class="card card-stredtch">
                                ...
                                <div class="form-inline flex-nowrap gx-3">
                                    <div class="form-wrap w-150px">
                                        <select id="method" class="form-select js-selsect2" data-search="on"
                                            ...
                                            <option value="paid"
                                                    @if (isset($method) && $method == 'paid') selected @endif>Paid
                                            </option>
                                            <option value="unpaid"
                                                    @if (isset($method) && $method == 'unpaid') selected @endif>
                                                Unpaid
                                            </option>
                                        </select>
                                    </div>
            ...
            <span class="d-none d-md-block">
                <button id="applyButton" class="btn btn-dim btn-outline-light disabled">Apply</button>
            </span>
            ...
            <div class="nk-tb-list is-separate is-medium mb-3">
                ...
                @foreach ($receipts as $donation)
                    <div class="nk-tb-item">
                        <div class="nk-tb-col nk-tb-col-check">
                            <div class="custom-control custom-control-sm custom-checkbox notext">
                                <input type="checkbox" class="custom-control-input donation-checkbox"
                                       id="oid{{ $loop->index }}">
                                <label class="custom-control-label" for="oid{{ $loop->index }}"></label>
                            </div>
                        </div>
                        <div class="nk-tb-col">
    ...
    @push('js')
        <script>
            ...
            document.addEventListener("DOMContentLoaded", function () {
                ...
                donationCheckboxes.forEach(function (checkbox) {
                    checkbox.addEventListener('change', function () {
                        const atLeastOneChecked = [...donationCheckboxes].some(function (cb) {
                            return cb.checked;
                        });
                        applyButton.disabled = !atLeastOneChecked;
                    });
                });
            });
        </script>
