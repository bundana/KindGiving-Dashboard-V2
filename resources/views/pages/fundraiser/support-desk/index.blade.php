...
@section('content')
    <!-- content @s
                                        -->
        @php
            use App\Models\Campaigns\{Donations, Campaign, CampaignTeamUsers, FundraiserAccount};
            ...
            $donations = Donations::where('creator', $user_id)->latest()->get();
            $agents = CampaignTeamUsers::where('user_id', $user_id)->get();
                                                        ...
                                                        <div class="row g-4">
                                                            <div class="col-sm-6 col-xxl-12">
                                                                <div class="nk-order-ovwg-data buy">
                                                                    <div class="amount">{{ number_format($fundraiserAccount->balance, 2) }} <small
                                                            ...
                                                            <div class="col-sm-6 col-xxl-12">
                                                                <div class="nk-order-ovwg-data sell">
                                                                    <div class="amount">{{ number_format($fundraiserAccount->topup_balance, 2) }} <small
                                                                            class="currenct currency-usd">GH₵</small></div>
                                                                    <div class="title"><em
