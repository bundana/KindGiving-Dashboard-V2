                    ...
                    <div class="components-preview wide-md mx-auto">
                        <div class="nk-block-head nk-block-head-lg wide-sm">
                            <div class="nk-block-head-content">
                                <h2 class="nk-block-title fw-normal">Generate and send payment link</h2>
                                ...
                                <div class="card-inner">
                                    <form action="{{  url()->full()  }}" class="form"
                                        ...
                                        <div class="row g-gs">
                                            ...
                                            <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="form-label">Notification Channel</label>
                                                 <div class="form-control-wrap">
                                                <div class="custom-control custom-radio">
    <input type="radio" id="sms_channel" name="channel" class="custom-control-input" value="sms">
    <label class="custom-control-label" for="sms_channel">SMS</label>
</div>
<div class="custom-control custom-control custom-radio">
    <input type="radio" id="whatsapp_channel" name="channel" class="custom-control-input"  value="whatsapp">
    <label class="custom-control-label" for="whatsapp_channel">WhatsApp</label>
</div></div>
                                                ...
                                                @enderror
                                                {{-- <div class="hint">
                                                    <span class="text-info">If it's donors first time receiving
                                                        notices via WhatsApp, please text our WhatsApp number
                                                        first.</span>
